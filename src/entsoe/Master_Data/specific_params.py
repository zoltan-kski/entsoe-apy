...
class ConfigurationDocument(Base):
    ...
    def __init__(
        ...
        """
        # Initialize base class with fixed document_type
        # Note: We don't pass period_start/period_end as they are not used for this endpoint
        super().__init__(
            document_type="A95",
            period_start=None,
            period_end=None,
        ...
        # Add fixed business type
        self.params["businessType"] = "B11"

        # Add mandatory bidding zone domain parameter
        self.validate_eic_code(bidding_zone_domain, "bidding_zone_domain")
        self.params["biddingZone_Domain"] = bidding_zone_domain

        # Add mandatory implementation date parameter
        self.params["implementation_DateAndOrTime"] = implementation_date_and_or_time

        # Add optional PSR type parameter
